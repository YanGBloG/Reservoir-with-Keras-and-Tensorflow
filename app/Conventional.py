...
from OilPropertiesCalculation import *
...
class Typical(QWidget):
    ...
    ### This part calculate PROPERTIES OF GAS        
        ...
        viscosity_icon.addPixmap(QPixmap(":/fig/mu.png"), QIcon.Normal, QIcon.Off)
        ...
        self.gas_output_label.setGeometry(QRect(10, 280, 171, 21))
        ...
        calculate_icon.addPixmap(QPixmap(":/fig/calculate.png"), QIcon.Normal, QIcon.Off)
        
        self.gas_calculate_button = QPushButton('Calculate', self)
        self.gas_calculate_button.setGeometry(QRect(190, 275, 101, 31))
        ...
        rho_icon = QIcon()
        rho_icon.addPixmap(QPixmap(":/fig/rho.png"), QIcon.Normal, QIcon.Off)
    ...
    ### This part calculate PROPERTIES OF OIL
        ...
        self.B_oil_corrs_label.setGeometry(QRect(30, 82, 21, 21))
        self.B_oil_corrs_label.setFont(norm_font_bold)
        self._b_oil = QLabel('oil', self.oil_corr)
        self._b_oil.setGeometry(QRect(45, 87, 21, 21))

        Bo_correlation_list = ['Standing', 'Glaso', 'Marhoun', 'Petrosky-Farshad']
        self.b_oil_corrs = QComboBox(self.oil_corr)
        self.b_oil_corrs.setGeometry(QRect(90, 85, 191, 21))
        for item in Bo_correlation_list:
            self.b_oil_corrs.addItem(item)

        self.C_oil_corrs_label = QLabel('C', self.oil_corr)
        self.C_oil_corrs_label.setGeometry(QRect(30, 116, 21, 21))
        self.C_oil_corrs_label.setFont(norm_font_bold)
        self._c_oil = QLabel('oil', self.oil_corr)
        self._c_oil.setGeometry(QRect(45, 123, 21, 21))

        c_oil_correlation_list = ['McCain', 'Petrosky-Farshad']
        self.c_oil_corrs = QComboBox(self.oil_corr)
        self.c_oil_corrs.setGeometry(QRect(90, 120, 191, 21))
        for item in c_oil_correlation_list:
            self.c_oil_corrs.addItem(item)

        self.dead_oil_label = QLabel('Dead', self.oil_viscosity_tab)
        self.dead_oil_label.setGeometry(QRect(32, 15, 41, 21))

        dead_oil_correlation_list = ['Beal', 'Beggs-Robinson', 'Glaso']
        self.dead_oil_corrs = QComboBox(self.oil_viscosity_tab)
        self.dead_oil_corrs.setGeometry(QRect(90, 15, 191, 21))
        for item in dead_oil_correlation_list:
            self.dead_oil_corrs.addItem(item)

        self.saturated_oil_label = QLabel('Saturated', self.oil_viscosity_tab)
        self.saturated_oil_label.setGeometry(QRect(17, 50, 61, 21))

        saturated_oil_correlation_list = ['Chew-Connally', 'Beggs-Robinson']
        self.saturated_oil_corrs = QComboBox(self.oil_viscosity_tab)
        self.saturated_oil_corrs.setGeometry(QRect(90, 50, 191, 21))
        for item in saturated_oil_correlation_list:
            self.saturated_oil_corrs.addItem(item)

        self.under_saturated_oil_label = QLabel('Under', self.oil_viscosity_tab)
        self.under_saturated_oil_label.setGeometry(QRect(30, 86, 41, 21))

        self.under_saturated_oil_corrs = QComboBox(self.oil_viscosity_tab)
        self.under_saturated_oil_corrs.setGeometry(QRect(90, 86, 191, 21))
        self.under_saturated_oil_corrs.addItem('Vasquez-Beggs')
        
        self.oil_output_label = QLabel('Output (Oil)', self)
        self.oil_output_label.setGeometry(QRect(320, 280, 171, 21))
        ...
        self.oil_calculate_button.setGeometry(QRect(500, 275, 101, 31))
        ...
        self.oil_calculate_button.clicked.connect(self.printGasOilResult)
        self.oil_calculate_button.clicked.connect(self.printWaterOilResult)
        ...
        self.dead_oil_viscosity_output_label = QPushButton(self)
        self.dead_oil_viscosity_output_label.setGeometry(QRect(322, 370, 21, 21))
        self.dead_oil_viscosity_output_label.setStyleSheet('border:none')
        self.dead_oil_viscosity_output_label.setIcon(viscosity_icon)
        self.dead_oil_viscosity_output_label.setIconSize(QSize(20, 20))
        self._dead_oil_viscosity = QLabel('Dead', self)
        self._dead_oil_viscosity.setGeometry(QRect(340, 374, 37, 21))

        self.dead_oil_display = QLineEdit(self)
        self.dead_oil_display.setGeometry(QRect(380, 371, 101, 21))
        self.dead_oil_display.setMaxLength(6)
        self.dead_oil_display.setReadOnly(True)
        self.dead_oil_display.setStyleSheet('background-color: #E1E1E1;')
        self.dead_oil_display.setAlignment(Qt.AlignRight)
        self.dead_oil_display.setText('0')

        self.dead_oil_viscosity_output_unit = QLineEdit(self)
        self.dead_oil_viscosity_output_unit.setGeometry(QRect(490, 371, 111, 21))
        self.dead_oil_viscosity_output_unit.setStyleSheet('background-color: #E1E1E1;')
        self.dead_oil_viscosity_output_unit.setText('cP')
        self.dead_oil_viscosity_output_unit.setReadOnly(True)

        self.oil_viscosity_output_label = QPushButton(self)
        self.oil_viscosity_output_label.setGeometry(QRect(330, 398, 21, 21))
        ...
        self._oil_viscosity.setGeometry(QRect(350, 403, 21, 21))

        self.oil_viscosity_display = QLineEdit(self)
        self.oil_viscosity_display.setGeometry(QRect(380, 400, 101, 21))
        ...
        self.oil_viscosity_output_unit.setGeometry(QRect(490, 400, 111, 21))
        ...
        self.oil_density_label.setGeometry(QRect(330, 428, 21, 21))
        ...
        self._oil_density.setGeometry(QRect(350, 432, 21, 21))

        self.oil_density_display = QLineEdit(self)
        self.oil_density_display.setGeometry(QRect(380, 430, 101, 21))
        ...
        self.oil_density_output_unit.setGeometry(QRect(490, 430, 111, 21))
        ...
        self.B_oil.setGeometry(QRect(335, 455, 21, 21))
        self.B_oil.setFont(norm_font_bold)
        self._oil_B = QLabel('oil', self)
        self._oil_B.setGeometry(QRect(350, 461, 41, 21))
        ...
        self.C_oil.setGeometry(QRect(335, 485, 21, 21))
        self.C_oil.setFont(norm_font_bold)
        self._oil_C = QLabel('oil', self)
        self._oil_C.setGeometry(QRect(350, 490, 21, 21))
    ...
    def getOilGravity(self):
        gas_unit = self.SG_oil_gas_unit.currentText()
        water_unit = self.SG_water_unit.currentText()

        while True:
            try:
                gamma_gas_init = float(self.SG_oil_gas.text())
    ...
    def exeGasProperties(self):
        while True:
            try:
                ...
                sg_gas, sg_water = self.getGasGravity()
    ...
    def exeOilProperties(self):
        while True:
            try:
                P = self.getPressure('oil')
                T = self.getTemperature('oil')
                sg_gas, API, sg_water = self.getOilGravity()
                sg_oil = 141.5 / (API + 131.5)
                Pb_correlation = self.pb_corrs.currentText()
                Rsb_correlation = self.rsb_corrs.currentText()
                Bo_correlation = self.b_oil_corrs.currentText()
                Co_correlation = self.c_oil_corrs.currentText()
                dead_oil = self.dead_oil_corrs.currentText()
                saturated_oil = self.saturated_oil_corrs.currentText()

                Rsb_initial = GasSolubility(P, T, API, sg_oil, sg_gas, Rsb_correlation)
                Rsb = Rsb_initial.Rs()

                Pbp_initial = BubblePointPressure(P, T, API, sg_oil, sg_gas, Rsb_correlation, Pb_correlation)
                Pbp = Pbp_initial.Pb()

                if P > Pbp:
                    Bo_initial = OilFVF(P, T, API, sg_oil, sg_gas, Rsb_correlation, Bo_correlation)
                    Bo = Bo_initial.Bo()
                else:
                    Bo_initial = OilFVFforUnderSaturated(P, T, API, sg_oil, sg_gas, Rsb_correlation, Pb_correlation, Bo_correlation)
                    Bo = Bo_initial.Petrosky_Farshad()
                

                Co_initial = IsothermalCompressibility(P, T, API, sg_oil, sg_gas, Rsb_correlation, Pb_correlation)
                Co = Co_initial.Co()

                        
                Density_initial = OilDensity(P, T, API, sg_oil, sg_gas, Rsb_correlation, Pb_correlation, Bo_correlation)
                        
                Viscosity_initial = OilVisCosity(P, T, API, sg_oil, sg_gas, Rsb_correlation, Pb_correlation, dead_oil, saturated_oil)
                if P > Pbp:
                    Oil_density = Density_initial.under_density()
                    V_dead = Viscosity_initial.V_dead_oil()
                    V_oil = Viscosity_initial.Under_oil()
                else:
                    Oil_density = Density_initial.saturated_density()
                    V_dead = Viscosity_initial.V_dead_oil()
                    V_oil = Viscosity_initial.Under_oil()
                return Rsb, Pbp, Bo, Co, Oil_density, V_dead, V_oil
            except:
                break
            

    def exeGasOilProperties(self):
        while True:
            try:
                P = self.getPressure('oil')
                T = self.getTemperature('oil')
    ...
    def printGasResult(self):
        while True:
            try:
                ...
                self.popupmsg('Invalid input values', 'warning')
                break
    ...
    def printOilResult(self):
        while True:
            try:
                Rsb, Pbp, Bo, Co, Oil_density, V_dead, V_oil = self.exeOilProperties()
                self.bubblepoint_pressure_display.setText(str(Pbp))
                self.solubility_display.setText(str(Rsb))
                self.dead_oil_display.setText(str(V_dead))
                self.oil_viscosity_display.setText(str(V_oil))
                self.oil_density_display.setText(str(Oil_density))
                self.B_oil_display.setText(str(Bo))
                self.C_oil_display.setText(str(Co))
                break
            except:
                self.popupmsg('Invalid input values', 'warning')
                break

    def printGasOilResult(self):
        while True:
            try:
                z, viscosity, density_of_gas, Bg, Cp = self.exeGasOilProperties()
                self.z_display.setText(str(z))
                self.viscosity_display.setText(str(viscosity))
                self.density_display.setText(str(density_of_gas))
                self.B_display.setText(str(Bg))
    ...
    def printWaterOilResult(self):
        while True:
            try:
                water_density, Bw, water_viscosity, Rsb, Cw = self.exeWaterOilProperties()
                setCw = str(Cw)[:6] + str(Cw)[-4:]
                self.Rsb_water_display.setText(str(Rsb))
                self.water_viscosity_display.setText(str(water_viscosity))
                self.water_density_display.setText(str(water_density))
