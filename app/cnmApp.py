...
class cnmApp(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('../pyqt5/fig/touch.png'))
...
### SECOND TAB DISPLAY
        ...
        activation_list = ['ReLU', 'Sigmoid', 'Tanh', 'Linear', 'Softmax']
        ...
        return_icon = QIcon()
        return_icon.addPixmap(QPixmap("../pyqt5/fig/return.png"), QIcon.Normal, QIcon.Off)        
        ...
        play_icon = QIcon()
        play_icon.addPixmap(QPixmap("../pyqt5/fig/icons_play.png"), QIcon.Normal, QIcon.Off)        
        ...
        stop_icon = QIcon()
        stop_icon.addPixmap(QPixmap("../pyqt5/fig/stop.png"), QIcon.Normal, QIcon.Off)
        ...
        plus_icon = QIcon()
        plus_icon.addPixmap(QPixmap("../pyqt5/fig/plus.png"), QIcon.Normal, QIcon.Off)
        ...
        minus_icon = QIcon()
        minus_icon.addPixmap(QPixmap("../pyqt5/fig/minus.png"), QIcon.Normal, QIcon.Off)
        ...
        add_nodes_icon.addPixmap(QPixmap("../pyqt5/fig/add_neurons.png"), QIcon.Normal, QIcon.Off)

        minus_nodes_icon = QIcon()
        minus_nodes_icon.addPixmap(QPixmap("../pyqt5/fig/minus_neurons.png"), QIcon.Normal, QIcon.Off)
    ...
    ### Theme widget tab 2
        ...
        iris_icon = QIcon()
        iris_icon.addPixmap(QPixmap("../pyqt5/fig/iris.ico"), QIcon.Normal, QIcon.Off)
        ...
        titanic_icon = QIcon()
        titanic_icon.addPixmap(QPixmap("../pyqt5/fig/titanic.ico"), QIcon.Normal, QIcon.Off)
        ...
        poro_icon = QIcon()
        poro_icon.addPixmap(QPixmap("../pyqt5/fig/poro.ico"), QIcon.Normal, QIcon.Off)
        ...
        houseprice_icon.addPixmap(QPixmap("../pyqt5/fig/houseprice.ico"), QIcon.Normal, QIcon.Off)
        ...
        load_icon = QIcon()
        load_icon.addPixmap(QPixmap("../pyqt5/fig/load_data.png"), QIcon.Normal, QIcon.Off)
        ...
        fullscreen_icon.addPixmap(QPixmap("../pyqt5/fig/fullScreen.png"), QIcon.Normal, QIcon.Off)
        ...
        trainview_icon.addPixmap(QPixmap("../pyqt5/fig/viewlog.png"), QIcon.Normal, QIcon.Off)
...
### THIRD TAB DISPLAY
        ...
        self.evaluation_view.setGeometry(QRect(3, 90, 401, 425))
        ...
        self.evaluation_figure_layout.setGeometry(QRect(4, 91, 399, 423))
        ...
        self.show_result_button.setGeometry(QRect(80, 520, 101, 31))
        self.show_result_button.clicked.connect(self.plotPredictResult)

        self.detail_button = QPushButton('Detail', self.results)
        self.detail_button.setGeometry(QRect(190, 520, 101, 31))

        self.save_result_button = QPushButton('Save', self.results)
        self.save_result_button.setGeometry(QRect(300, 520, 101, 31))

        self.result_view = QGraphicsView(self.results)
        self.result_view.setGeometry(QRect(406, 0, 861, 553))
        ...
        self.result_figure_layout.setGeometry(QRect(407, 1, 859, 551))
...
### SECOND TAB CONFIGURATION
    ...
    def train_model_process(self):
        ...
        model = RegressionModel(link_to_dataset, list_of_hidden_nodes, test_size, learning_rate, epochs, batch_size, optimizer)
        model.trainModel()
...
### THIRD TAB CONFIGURATION
    ...
    def getPredictData(self):
        ...
        model = RegressionModel(link_to_dataset, list_of_hidden_nodes, test_size, learning_rate, epochs, batch_size, optimizer)
        X_train, X_valid, y_train, y_valid, X_test, y_test, depth = model.split_to_train_and_test_set()
        return X_test, y_test, depth
